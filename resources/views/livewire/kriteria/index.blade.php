	...
	<div class="container mx-auto px-4 sm:px-8">
		<div class="py-8">
			<div class="flex items-center justify-between">
				...
				<x-nav-link href="{{ route('kriteria.create') }}">Tambah Kriteria</x-nav-link>
			</div>
					...
					<table class="min-w-full leading-normal">
						...
						<tbody>
							...
							<tr>
								...
								<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
									<x-nav-link href="{{ route('subkriteria.create', $krit->id) }}">Tambah</x-nav-link>
								</td>
								<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
									<div class="flex items-center justify-end gap-4">
										<a href="{{ route('kriteria.edit', $krit->id) }}" class="uppercase font-medium text-xs text-gray-700">Ubah</a>
										<x-button wire:click="delete({{ $krit->id }})">Hapus</x-button>
									</div>
								</td>
							</tr>
